        ...
        <div class="col-sm-12 p-0">
          <div class="row h-100 align-items-center">
            <div class="col beacon-logo-container">
              <img src="./../assets/logo.png" alt="Beacon Südtirol - Alto Adige">
            </div>
          </div>
        </div>
        ...
        <form class="login-form col-sm p-0">
          <div class="input row justify-content-center" v-show="hasError">
            <span class="col-sm alert alert-danger error-message" role="alert">
              Bitte erneut anmelden. Fehlermeldung: {{ getError }}
            </span>
          </div>
          <div class="input row">
            <div class="col-sm">
          ...
          <div class="input row">
            <div class="col-sm">
              <input type="password" id="password" name="password" placeholder="Password" v-model="password" :class="'form-control' + (hasError ? ' is-invalid' : '')">
            </div>
          </div>
          <div class="input row">
            <div class="col-sm">
